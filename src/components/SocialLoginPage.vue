<template>
    <div class="signup-buttons">
        <div id="fb-root"></div>
        <a href="https://my-first-app-0304.herokuapp.com/google" class="google-signup" >
...
export default {
  ...
  methods: {
    loginWithGoogle () {
      axios.get('https://my-first-app-0304.herokuapp.com/google')      
        .then(res => {
          // return GoogleUser
          // on success do something
          console.log('GoogleUser', res)
